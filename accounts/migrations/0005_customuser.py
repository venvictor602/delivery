...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('accounts', '0004_timeline_tracking'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('front_picture', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('back_picture', models.ImageField(blank=True, null=True, upload_to='images/')),
